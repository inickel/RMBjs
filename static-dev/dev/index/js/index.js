...
window.ANT = {
    Menu, Icon, Button, Row, Col, Spin, Table
};
        ...
        render: ()=> {
            return <div className="index">
                <div className="index-top">
                    ...
                    <div className="index-github"><a href="https://github.com/TNT-F2E/RMBjs" target="_blank"><Icon
                        type="github"/> Github</a></div>
                    <div>
                        <div className="index-start">Let's start!</div>
                    </div>
                </div>
            ...
            return (
                <div className="main">
                    <div className="banner">
                        ...
                        <div id="mainmenu">
                            <Menu onClick={this.handleClick}
                                ...
                                <Menu.Item key="index"><Link to="/index"><Icon
                                    type="home"/><span>首页</span></Link></Menu.Item>
                                <Menu.Item key="build"><Link to="/build"><Icon
                                    type="caret-circle-o-right"/><span>构建工具</span></Link></Menu.Item>
                    ...
                    <div className="footer">
                        <div>我们是虚拟世界的建筑师</div>
                        <div className="issues">问题与建议:<a href="https://github.com/TNT-F2E/RMBjs/issues" target="_blank">
                            <Icon type="github"/> Issues</a></div>
                ...
                <div className="componentsBody">
                    <div id="menutree">
                        <Menu onClick={this.handleClick}
                              ...
                              mode="inline"
                        >
                            <Menu.Item key="guide"><Link to="/wapcomponents/guide"><Icon
                                type="question-circle-o"/><span>快速上手</span></Link></Menu.Item>
